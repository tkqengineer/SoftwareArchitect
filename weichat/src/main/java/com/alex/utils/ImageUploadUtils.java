...
public class ImageUploadUtils {
	...
	public static void main(String[] args) throws KeyManagementException, NoSuchAlgorithmException, NoSuchProviderException, IOException {
		System.out.println(upload("E:/1.png", "HDj5LnwMCIabobdfAMtL_RaPLjjj9LMus9UWAU-yAuSAciCbor9B7s6C8eiKAPPC5U-k_k8YWS72vObOhxPM-dq4RVrO9MN8fWWLlM9K56U2Lld94FcWXk-woYcF4NwiXITiAFATEP", "image"));
